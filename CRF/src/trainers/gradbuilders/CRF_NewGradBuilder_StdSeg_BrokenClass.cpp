/*
 * CRF_NewGradBuilder_StdSeg_BrokenClass.cpp
 *
...
CRF_NewGradBuilder_StdSeg_BrokenClass::CRF_NewGradBuilder_StdSeg_BrokenClass(CRF_Model* crf_in)
	: CRF_NewGradBuilder_StdSeg(crf_in)
{

}

CRF_NewGradBuilder_StdSeg_BrokenClass::~CRF_NewGradBuilder_StdSeg_BrokenClass()
{
	cerr << "CRF_NewGradBuilder_StdSeg_BrokenClass destructor" << endl;
}

/*
 * CRF_NewGradBuilder_StdSeg_BrokenClass::buildGradient
 *
 ...
 */
double CRF_NewGradBuilder_StdSeg_BrokenClass::buildGradient(CRF_FeatureStream* ftr_strm, double* grad, double* Zx_out)
{
