...
CRF_NewGradBuilder_StdSeg::CRF_NewGradBuilder_StdSeg(CRF_Model* crf_in)
	: CRF_NewGradBuilder(crf_in)
{

}

CRF_NewGradBuilder_StdSeg::~CRF_NewGradBuilder_StdSeg()
{
	cerr << "CRF_NewGradBuilder_StdSeg destructor" << endl;
}

/*
 * CRF_NewGradBuilder_StdSeg::buildGradient
 *
 ...
 */
double CRF_NewGradBuilder_StdSeg::buildGradient(CRF_FeatureStream* ftr_strm, double* grad, double* Zx_out)
{
	// just for debugging
//	cout << endl << "CRF_NewGradBuilder_StdSeg::buildGradient()" << endl << endl;
