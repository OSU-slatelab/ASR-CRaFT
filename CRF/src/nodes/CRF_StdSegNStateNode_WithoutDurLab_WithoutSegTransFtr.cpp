...
{
	// just for debugging
//	cout << "CRF_StdSegNStateNode_WithoutDurLab_WithoutSegTransFtr::computeTransMatrix(): " << endl;
...
{
	// just for debugging
//	cout << "CRF_StdSegNStateNode_WithoutDurLab_WithoutSegTransFtr::computeAlpha(): " << endl;
...
{
	// just for debugging
//	cout << "CRF_StdSegNStateNode_WithoutDurLab_WithoutSegTransFtr::computeFirstAlpha()" << endl;
...
{
	// just for debugging
//	cout << "CRF_StdSegNStateNode_WithoutDurLab_WithoutSegTransFtr::computeBeta(): " << endl;
...
//	cout << "CRF_StdSegNStateNode_WithoutDurLab_WithoutSegTransFtr::computeExpF(): Very beginning!!" << endl;
