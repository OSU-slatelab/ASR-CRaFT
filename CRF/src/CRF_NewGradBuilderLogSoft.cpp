...
#include "CRF_NewGradBuilderLogSoft.h"

CRF_NewGradBuilderLogSoft::CRF_NewGradBuilderLogSoft(CRF_Model* crf_in)
...
CRF_NewGradBuilderLogSoft::~CRF_NewGradBuilderLogSoft() {
	// TODO Auto-generated destructor stub
}

double CRF_NewGradBuilderLogSoft::buildGradient(CRF_FeatureStream* ftr_strm, double* grad, double* Zx_out)
{
	if (this->lb == NULL ) {
