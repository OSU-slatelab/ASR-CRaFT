...
//	virtual int buildLattice(VectorFst<Arc>*fst, bool align=false, VectorFst<Arc>*alignFst=NULL,bool norm=true);
//	virtual int nStateBuildLattice(VectorFst<Arc>*fst, bool align=false, VectorFst<Arc>*alignFst=NULL, bool norm=true);
//	virtual int buildLattice(VectorFst<ArcTpl<FloatWeight> >*fst, bool align=false, VectorFst<ArcTpl<FloatWeight> >*alignFst=NULL,bool norm=true);
//	virtual int nStateBuildLattice(VectorFst<ArcTpl<FloatWeight> >*fst, bool align=false, VectorFst<ArcTpl<FloatWeight> >*alignFst=NULL, bool norm=true);

	// Changed by Ryan: since the template class CRF_LatticeBuilderTemplate is used to simulate virtual functions, these functions do not need to be virtual.
	StdVectorFst* buildLattice();
	int getAlignmentGammas(vector<double> *denominatorStateGamma,
									vector<double> *numeratorStateGamma,
									vector<double> *denominatorTransGamma,
									vector<double> *numeratorTransGamma);
	int getAlignmentGammasNState(vector<double> *denominatorStateGamma,
									vector<double> *numeratorStateGamma,
									vector<double> *denominatorTransGamma,
									vector<double> *numeratorTransGamma);
	CRF_StateVector* getNodeList();
	void computeAlignedAlphaBeta(Fst<LogArc>& fst, int nstates);
};
...
template <class Arc> int CRF_LatticeBuilder::buildLattice(VectorFst<Arc>* fst,
									  ...
									  bool norm) {
//int CRF_LatticeBuilder::buildLattice(VectorFst<ArcTpl<FloatWeight> >* fst,
//									  bool align,
//									  VectorFst<ArcTpl<FloatWeight> >*labFst,
//									  bool norm) {

	// Added by Ryan
//	typedef ArcTpl<FloatWeight> Arc;
...
template <class Arc> int CRF_LatticeBuilder::nStateBuildLattice(VectorFst<Arc>* fst,
									  ...
									  VectorFst<Arc>*labFst,
									  bool norm) {
//int CRF_LatticeBuilder::nStateBuildLattice(VectorFst<ArcTpl<FloatWeight> >* fst,
//									  bool align,
//									  VectorFst<ArcTpl<FloatWeight> >*labFst,
//									  bool norm) {
