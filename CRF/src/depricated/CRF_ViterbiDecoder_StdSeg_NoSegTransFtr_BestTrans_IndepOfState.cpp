/*
 * CRF_ViterbiDecoder_StdSeg_NoSegTransFtr_BestTrans_IndepOfState.cpp
 *
 *  Created on: Feb 6, 2012
 *      Author: hey
 */

#include "CRF_ViterbiDecoder_StdSeg_NoSegTransFtr_BestTrans_IndepOfState.h"
#include <cmath>
#include <vector>
#include <deque>
#include <map>
...
template <class CRF_VtbNode> void CRF_ViterbiDecoder_StdSeg_NoSegTransFtr<CRF_VtbNode>::stateFeatureUpdate(uint nodeCnt)
{
	// just for debugging
