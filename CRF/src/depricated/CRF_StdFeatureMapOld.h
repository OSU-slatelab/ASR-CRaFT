#ifndef CRF_STDFEATUREMAPOLD_H_
#define CRF_STDFEATUREMAPOLD_H_

#include "CRF_FeatureMap.h"

class CRF_StdFeatureMapOld : public CRF_FeatureMap
{
protected:
	QNUInt32 numLabs;
	QNUInt32 numFeas;
	...
	double transBiasVal;
public:
	CRF_StdFeatureMapOld(QNUInt32 nlabs, QNUInt32 nfeas);
	virtual ~CRF_StdFeatureMapOld();
