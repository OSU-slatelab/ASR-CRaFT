...
mylocal/timit_data_prep.sh $timit || exit 1
...
# added the support to the enhanced test set
mylocal/timit_format_data.sh || exit 1
...
for x in train dev test enh; do 
...
steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/mono/graph data/enh exp/mono/decode_enh &
...
steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/tri1/graph data/enh exp/tri1/decode_enh &
...
steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/tri2/graph data/enh exp/tri2/decode_enh &
...
mysteps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
...
mysteps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/tri3/graph data/enh exp/tri3/decode_enh &
